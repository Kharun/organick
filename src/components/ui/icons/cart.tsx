export const Cart = () => {
  return (
    <svg width="27" height="24" viewBox="0 0 27 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M20.1243 23.0001C20.7993 23.0001 21.3465 22.4529 21.3465 21.7779C21.3465 21.1029 20.7993 20.5557 20.1243 20.5557C19.4493 20.5557 18.9021 21.1029 18.9021 21.7779C18.9021 22.4529 19.4493 23.0001 20.1243 23.0001Z"
        fill="white"
        stroke="white"
        strokeWidth="1.5"
        strokeLinecap="round"
